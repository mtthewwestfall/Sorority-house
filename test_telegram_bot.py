...
class TestTelegramBotWebcamShow(unittest.TestCase):
    ...
    def test_portrait_url_uses_keyhole_door_files(self):
        ...
        self.assertTrue(chloe.endswith("/assets/chloe-1.jpg"))
        self.assertTrue(bailey.endswith("/assets/bailey-1.jpg"))
        self.assertNotEqual(chloe, bailey)
        swapped = "https://keyhole-latest-production.up.railway.app/assets/bailey-1.jpg"
        self.assertTrue(bot._portrait_url({"girl": "chloe", "avatar_url": swapped}).endswith("chloe-1.jpg"))
    ...
    def test_preview_uses_door_photo_unless_video(self):
        ...
        self.assertTrue(url.endswith("/assets/chloe-1.jpg"))
    ...
    def test_cmd_models_sends_both_door_portraits(self):
        ...
        self.assertTrue(send.await_args_list[0].args[1]["avatar_url"].endswith("chloe-1.jpg"))
        self.assertTrue(send.await_args_list[1].args[1]["avatar_url"].endswith("bailey-1.jpg"))
    ...
    def test_keyhole_door_avatar_migration_leaves_other_girls(self):
        ...
        self.assertTrue(main.KEYHOLE_DOOR_AVATARS["bailey"].endswith("/assets/bailey-1.jpg"))
        self.assertTrue(main.KEYHOLE_DOOR_AVATARS["chloe"].endswith("/assets/chloe-1.jpg"))
        ...
        swapped = "https://keyhole-latest-production.up.railway.app/assets/chloe-1.jpg"
        ...
        self.assertTrue(updated["chloe"].endswith("chloe-1.jpg"))
        self.assertTrue(updated["bailey"].endswith("bailey-1.jpg"))
